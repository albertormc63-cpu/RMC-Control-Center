...
const source = {
  name: "Registro de impresion de etiquetas",
  area: "Almacen / Costura",
  source_type: "label_delivery_excel",
  file_path: "/Volumes/Carpeta de sublimado/Etiquetas/Registro de impresion de etiquetas.xlsx",
  sheet_name: "Registro"
};
...
if (!existsOnDisk) {
  ...
  console.warn("El archivo no existe o el volumen no esta montado:");
  console.warn(source.file_path);
  console.warn("");
  console.warn("Aun asi se registrara la fuente en BD.");
  console.warn("Despues podremos sincronizar cuando el volumen este disponible.");
}
...
if (existing) {
  ...
  console.log("");
  console.log("Fuente ya existia. Se actualizo:");
